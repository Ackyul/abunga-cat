...
const Register = () => {
  ...
  const handleFacebookLogin = () => {
    const returnTo = sessionStorage.getItem("last_visited_page") || "/profile";
    window.location.href = `/api/users/facebook?returnTo=${encodeURIComponent(returnTo)}`;
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 flex items-center justify-center py-3 px-4 border border-gray-200 rounded-2xl shadow-xs bg-white hover:bg-gray-50 text-xs sm:text-sm font-semibold text-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#95b721] transition-all cursor-pointer"
                >
                  <svg className="w-5 h-5 mr-2 shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center py-3 px-4 border border-blue-600 rounded-2xl shadow-xs bg-[#1877F2] hover:bg-[#166fe5] text-xs sm:text-sm font-semibold text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1877F2] transition-all cursor-pointer"
                >
                  <svg className="w-5 h-5 mr-2 shrink-0 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
